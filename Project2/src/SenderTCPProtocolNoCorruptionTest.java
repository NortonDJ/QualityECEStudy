...
/**
 * The test class SenderTCPProtocolNoCorruptionTest.
 *
 * @author  (your name)
 * @version (a version number or a date)
 */
public class SenderTCPProtocolNoCorruptionTest
{
    ...
    /**
     * Default constructor for test class SenderTCPProtocolNoCorruptionTest
     */
    public SenderTCPProtocolNoCorruptionTest()
    {
